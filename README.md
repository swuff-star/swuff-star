...
This GitHub profile is dedicated to uploading, maintaining, and showcasing my most significant works, many of which are higlighted throughout this README. Unless otherwise specified, most of this work is within the [Starstorm 2 repository](https://github.com/TeamMoonstorm/Starstorm2), and I handled most of if not all implementation pertaining to code & getting assets in-engine unless otherwise stated:
...
## HUNK (Standalone)
A collaboratively made playable character who has a unique type of loot in the form of various equippable firearms that each have limited ammo and must be cycled between and upgraded as they are obtained. My contributions were in the form of code implementing weapon spawns in each scene for each HUNK player, systems relating to spawning and unlocking said unique spawns, the character's 'Utility' skill which performs a roll only if an attacking enemy is nearby, and some behavior of some elite 'virus'-type enemies. This was co-developed, with the rest of the character and the mod's features being handled by another passionate modder.
...
![Follower](https://github.com/swuff-star/swuff-star/blob/main/follower-gif1.gif?raw=true)

![Wayfarer](https://github.com/swuff-star/swuff-star/blob/main/wayfarer-gif1.gif?raw=true)

## Rushrum
A tiny nuisence that runs around the player, either hoping to distract them or slip in close unnoticed to attack!

![Rushrum](https://github.com/swuff-star/swuff-star/blob/main/rushrum-gif.gif?raw=true)

## Drones & Drone Upgrader (Lost in Transit)
...
![Beam Drone](https://github.com/swuff-star/swuff-star/blob/main/beamdrone-gif1.gif?raw=true)

![Duplicator Drone](https://github.com/swuff-star/swuff-star/blob/main/duplicator-gif1.gif?raw=true)

![Drone Table](https://github.com/swuff-star/swuff-star/blob/main/drones-gif1.gif?raw=true)
...
![Field Accelerator](https://github.com/swuff-star/swuff-star/blob/main/fieldaccelerator-gif1.gif?raw=true)

![Hunters Sigil](https://github.com/swuff-star/swuff-star/blob/main/sigil-gif1.gif?raw=true)
...
![Ethereal Shrine](https://github.com/swuff-star/swuff-star/blob/main/ethterminal-gif1.gif?raw=true)

![Ethereal Boss](https://github.com/swuff-star/swuff-star/blob/main/ethboss-gif1.gif?raw=true)

![Ethereal Beam](https://github.com/swuff-star/swuff-star/blob/main/ethPillarCompressed.gif?raw=true)

![Ethereal Elite](https://github.com/swuff-star/swuff-star/blob/main/ethLemBlaz.gif?raw=true)

## Zanzan the Faded (Scavenger Trader)
A passive NPC who can be interacted with, allowing the player to give an item in exchange for an item of similar 'value'. 'Value' is an arbitrarily designated value 0-100, reflective of item tier and a randomly generated item preference that is unique to each run. Favorite items have inflated value, potentially allowing a player to potentially bring many of a weak 'favorite' item to increase (or decrease..!) their value - though, each trade has diminishing returns.

![Zanzan](https://github.com/swuff-star/swuff-star/blob/main/zanzan-gif1.gif?raw=true)
...
![NemHunt](https://github.com/swuff-star/swuff-star/blob/main/nemtress-gif1.gif?raw=true)
...
![Bladedancer](https://github.com/swuff-star/swuff-star/blob/main/bladedancer-gif1.gif?raw=true)
...
A collaborative fangame that reimagines the basics of Risk of Rain 1, though redesigned from the ground up with freely aimed skills, more detailed terrain types, and enemies to fit these new mechanics. I primarily handled implementation of playable characters, monsters, and stages - this was co-developed with a good friend / fellow passionate modder.

![Grass](https://github.com/swuff-star/swuff-star/blob/main/grassDisruption.gif?raw=true)

![Behind You](https://github.com/swuff-star/swuff-star/blob/main/behindYou.gif?raw=true)

![Commando](https://github.com/swuff-star/swuff-star/blob/main/commandoStruggle.gif?raw=true)

![Executioner](https://github.com/swuff-star/swuff-star/blob/main/exeShowcase.gif?raw=true)

![Crushed.](https://github.com/swuff-star/swuff-star/blob/main/crushed.gif?raw=true)

## Risk of Rain Returns Modding
